...
CFDistroId = os.environ['CFDISTROID'] # CF Id 
HeaderName = os.environ['HEADERNAME'] # Authorization
OriginUrl = os.environ['ORIGINURL']   # API url
...
#   return {
#         'statusCode': 200,
#         'body': json.dumps('Rotation Lambda.')
#     }
